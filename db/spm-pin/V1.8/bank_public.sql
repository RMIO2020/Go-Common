CREATE TABLE `bank_public` (
  ...
  `bank_card_username` varchar(128) NOT NULL DEFAULT '' COMMENT '账户名称',
  `bank_card` varchar(128) NOT NULL DEFAULT '' COMMENT '银行名称',
  `bank_card_no` varchar(128) NOT NULL DEFAULT '' COMMENT '银行账户（卡号）',
