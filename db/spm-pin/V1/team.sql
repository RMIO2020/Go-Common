CREATE TABLE `team` (
  ...
  `event_time_start` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '活动开始时间',
  `event_time_end` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '活动结束时间',
  `delivery_time_start` date NOT NULL DEFAULT '0000-00-00' COMMENT '预计发货开始时间',
  `delivery_time_end` date NOT NULL DEFAULT '0000-00-00' COMMENT '预计发货结束时间',
  `shelf_time_start` date NOT NULL DEFAULT '0000-00-00' COMMENT '预计上架开始时间',
  `shelf_time_end` date NOT NULL DEFAULT '0000-00-00' COMMENT '预计上架结束时间',
