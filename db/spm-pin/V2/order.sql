...
ALTER TABLE `order` ADD COLUMN `pay_flow`  text NOT NULL COMMENT '支付流水' AFTER `refund_time`;
ALTER TABLE `order` ADD COLUMN `refund_flow`  text NOT NULL COMMENT '退款流水' AFTER `pay_flow`;
