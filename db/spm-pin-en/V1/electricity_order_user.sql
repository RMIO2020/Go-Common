CREATE TABLE `electricity_order_user` (
  ...
  `pay_order_no` varchar(256) NOT NULL DEFAULT '' COMMENT '支付订单号',
  `order_name` varchar(256) NOT NULL DEFAULT '' COMMENT '电费单名称',
  `latest_payment_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '最迟还款时间',
  ...
  `currency` enum('','CNY','USD','USDT') NOT NULL DEFAULT '' COMMENT '支付币种',
  ...
  `deduction_type` enum('PAY','STORE') NOT NULL DEFAULT 'PAY' COMMENT '扣费方式',
  `deduction_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '抵扣时间',
